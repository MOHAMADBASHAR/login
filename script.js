...
btnOpen.addEventListener("click", function(){
    ...
    document.getElementById(`icon`).classList.remove(`basarili`,`basarisiz`)
    ...
    if(email == "muhammed@gmail.com" && passwor == "123"){
        document.getElementById(`icon`).classList.add(`basarili`)
        let alertContent = document.getElementById(`alertText`).innerHTML = `GIRIS BASARILI`
    }
    else{
        document.getElementById(`icon`).classList.add(`basarisiz`)
